...
public class TabsInputWidget extends AbstractInputWidget {
    ...
    public static final Texture TAB_LEFT = new Texture("logicnetworks:textures/gui/input_widgets_extended.png", 64, 64, 4, 14, 15, 12);
    public static final Texture TAB_FILL = new Texture("logicnetworks:textures/gui/input_widgets_extended.png", 64, 64, 64, 14, 0, 30);
    public static final Texture TAB_RIGHT = new Texture("logicnetworks:textures/gui/input_widgets_extended.png", 64, 64, 4, 14, 24, 12);
    public static final Texture TAB_HOVERED_LEFT = new Texture("logicnetworks:textures/gui/input_widgets_extended.png", 64, 64, 4, 14, 30, 12);
    public static final Texture TAB_HOVERED_FILL = new Texture("logicnetworks:textures/gui/input_widgets_extended.png", 64, 64, 64, 1, 0, 29);
    public static final Texture TAB_HOVERED_RIGHT = new Texture("logicnetworks:textures/gui/input_widgets_extended.png", 64, 64, 4, 14, 39, 12);
    public static final Texture TAB_SELECTED_LEFT = new Texture("logicnetworks:textures/gui/input_widgets_extended.png", 64, 64, 4, 17, 0, 12);
    public static final Texture TAB_SELECTED_FILL = new Texture("logicnetworks:textures/gui/input_widgets_extended.png", 64, 64, 64, 17, 0, 44);
    public static final Texture TAB_SELECTED_RIGHT = new Texture("logicnetworks:textures/gui/input_widgets_extended.png", 64, 64, 4, 17, 9, 12);

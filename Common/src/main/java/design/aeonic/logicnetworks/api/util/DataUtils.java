...
public class DataUtils {
    ...
    public static char charFromShort(short s) {
        return (char) ((int) s + (int) Short.MAX_VALUE);
    }

    public static short shortFromChar(char c) {
        return (short) ((int) c - (int) Short.MAX_VALUE);
    }

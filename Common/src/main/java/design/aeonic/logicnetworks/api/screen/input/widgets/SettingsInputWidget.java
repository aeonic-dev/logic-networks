...
public class SettingsInputWidget extends AbstractInputWidget {
    public static final Texture HIGHLIGHT = new Texture("logicnetworks:textures/gui/input_widgets_extended.png", 64, 64, 16, 16, 28, 48);

    public static final Texture NORMAL = new Texture("logicnetworks:textures/gui/input_widgets_extended.png", 64, 64, 14, 14, 0, 49);

    public static final Texture CLICKED = new Texture("logicnetworks:textures/gui/input_widgets_extended.png", 64, 64, 14, 14, 14, 49);

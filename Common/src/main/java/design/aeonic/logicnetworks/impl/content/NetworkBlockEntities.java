...
import design.aeonic.logicnetworks.impl.platform.Services;
import net.minecraft.world.level.block.entity.BlockEntityType;

public final class NetworkBlockEntities {
    public static final BlockEntityType<NetworkControllerBlockEntity> NETWORK_CONTROLLER = Services.ACCESS.blockEntityType(
            NetworkControllerBlockEntity::new, NetworkBlocks.NETWORK_CONTROLLER);
